...
$status=0;
$sql="INSERT INTO tblbooking(PackageId,UserEmail,FromDate,ToDate,total_person,Comment,status) VALUES(:pid,:useremail,:fromdate,:todate,:total_person,:comment,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':pid',$pid,PDO::PARAM_INT);
$query->bindParam(':useremail',$useremail,PDO::PARAM_STR);
$query->bindParam(':fromdate',$fromdate,PDO::PARAM_STR);
$query->bindParam(':todate',$todate,PDO::PARAM_STR);
$query->bindParam(':total_person',$total_person,PDO::PARAM_INT);
...
if($lastInsertId)
{
$msg="Your Booking Request Submitted Successfully";
}
else 
{
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="bnr-right mt-2">
				<label class="inputLabel">Total Person</label>
				<input class="form-control" id="" type="number" placeholder="" name="total_person" min="1" required="">
			</div>
			</div>
