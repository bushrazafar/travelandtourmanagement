...
$sql="update tblflights set FlightName=:pname,UpdationDate=:pdate where flightid=:pid";
...
<?php 
$pid=intval($_GET['pid']);
$sql = "SELECT* FROM tblflights WHERE tblflights.flightid=:pid";
$query = $dbh -> prepare($sql);
...
{	?>
                            ...
                            <div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control1" name="pname" id="pname" placeholder="Plane Name" value="<?php echo htmlentities($result->FlightName);?>" required>
									</div>
                                </div>
