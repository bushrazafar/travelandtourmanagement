...
$sql="INSERT INTO  tblguestbooking(FlightId,DepartureFrom,GoingTo,TravelCategory,TravelPerson,DepartureDate,ArrivalDate,HotelId,CheckIn,CheckOut,GuestPerson,Comment,TravellerName,CNIC,ContactNo,Gender,Email,WorkPurpose,BookingFor,CarBooking,CreationDate) 
            VALUES(:flightId,:d_cityId,:to_cityId,:t_category,:tperson,:d_date,:a_date,:dhotelId,
            :cdate,:odate,:hperson,:comment,:fname,:cnumber,:mnumber,:dgender,:uemail,:rdWork,:rdBook,
            :defaultCheck1,:pdate)";
...
if($lastInsertId)
{
   ...
   try {
    ...
    '<b>Departure Flight:  </b>'.$d_date.'<br/>'.'<b>No of Travellers: </b>'.$tperson.'<br/>'.'<b> Booking For Work: </b>'.$rdWork
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;"> Reservation </h3>
				...
				<ul>
                 ...
                 <div class="row">
                    ...
                    <div class="row">     
                              ...
                              <div class="form-group">
                              <label>Gender</label>
                              <select style="margin-top: -1px;" name="dgender" id="dgender" class="form-control">
...
<?php
     $flightid =  $_POST['dflight'];
     $flightsql = "SELECT * from tblflights WHERE tblflights.flightid=".$flightid;
						 $flightquery = $dbh->prepare($flightsql);
						 $flightquery->execute();
             $flightresult = $flightquery ->fetchAll();
             if($flightquery->rowCount() > 0){
  ...
  ?>
<input type="hidden" name="dflight" id="dflight" value="<?php echo $_POST['dflight'];?>" class="form-control" placeholder="" aria-describedby="helpId">
  <p><b>Flight Name &nbsp;&rarr;</b> <?php echo $flightname;?></p>
  <input type="hidden" name="flightName" id="flightName" value="<?php echo $flightname;?>" class="form-control" placeholder="" aria-describedby="helpId">
  
</div>
<div class="form-group">
<?php
     $Cityid =  $_POST['dcity'];
     $Citysql = "SELECT * from tblcities WHERE tblcities.CityId=".$Cityid;
						 $Cityquery = $dbh->prepare($Citysql);
						 $Cityquery->execute();
             $Cityresult = $Cityquery ->fetchAll();
             if($Cityquery->rowCount() > 0){
               foreach($Cityresult as $result){
  ...
  ?>
  <p><b>Departure From &rarr;</b> <?php echo $Cityname;?>&nbsp;&nbsp;</p>
  <input type="hidden" name="d_cityId" id="d_cityId" value="<?php echo $_POST['dcity'];?>" class="form-control" placeholder="" aria-describedby="helpId">
  <p><b>Going To &rarr;</b> <?php echo $_POST['CityName'];?></p>
  <input type="hidden" name="to_cityId" id="to_cityId" value="<?php echo $_POST['CityId'];?>" class="form-control" placeholder="" aria-describedby="helpId">
</div>
<div class="form-group">
  <p><b>Travelling Class </b> <?php echo $_POST['tcategory'];?></p>
  <input type="hidden" name="t_category" id="t_category" value="<?php echo $_POST['tcategory'];?>" class="form-control" placeholder="" aria-describedby="helpId">
  <p><b>No Of Travellers </b> <?php echo $_POST['tperson'];?></p>
...
<div class="form-group">
  <p><b>Departure Date </b> <?php echo $_POST['ddate'];?></p>
  <input type="hidden" name="d_date" id="d_date" value="<?php echo $_POST['ddate'];?>" class="form-control" placeholder="" aria-describedby="helpId">
  <p><b>Arrival Date </b> <?php echo $_POST['rdate'];?></p>
  <input type="hidden" name="a_date" id="a_date" value="<?php echo $_POST['rdate'];?>" class="form-control" placeholder="" aria-describedby="helpId">
</div>
<h4> Hotel Deatils</h4>
<div class="form-group">
  
  <p><b>Hotel Name </b> <?php echo $_POST['HotelName'];?></p>
  <input type="hidden" name="dhotelId" id="dhotelId" value="<?php echo $_POST['HotelId'];?>" class="form-control" placeholder="" aria-describedby="helpId">
</div>
<div class="form-group">
  <p><b>Check In Date </b> <?php echo $_POST['cdate'];?></p>
  <input type="hidden" name="cdate" id="cdate" value="<?php echo $_POST['cdate'];?>" class="form-control" placeholder="" aria-describedby="helpId">
  <p><b>Check Out Date </b> <?php echo $_POST['odate'];?></p>
  <input type="hidden" name="odate" id="odate" value="<?php echo $_POST['odate'];?>" class="form-control" placeholder="" aria-describedby="helpId">
</div>
<div class="form-group">
  <p><b>No of Guest Person </b> <?php echo $_POST['hperson'];?></p>
...
<div class="form-group">
  <p><b>Comments </b> <?php echo $_POST['comment'];?></p>
