				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Packages</h2>
						...
						<tbody>
<?php $sql = "SELECT tblhotels.HotelName,tblhotels.CreationDate,tblhotels.StayPrice,tblhotels.HotelId,tblcountries.CountryName FROM tblhotels JOIN tblcountries ON tblcountries.countryid = tblhotels.CountryId";
...
{				?>		
						  <tr>
                            ...
                            <td>Rs<?php echo htmlentities($result->StayPrice);?></td>
