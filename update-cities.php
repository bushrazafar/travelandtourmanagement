...
$sql="update tblcities set CityName=:cname,countryid=:dcountry,UpdationDate=:pdate where CityId=:pid";
...
<?php 
$pid=intval($_GET['pid']);
$sql = "SELECT * from tblcities where CityId=:pid";
$query = $dbh -> prepare($sql);
...
{	?>
                            ...
                            <div class="form-group">
									...
									<div class="col-sm-4">
                                 <select class="form-control" name="dcountry" id="dcountry" required> 
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="cname" id="cname" value="<?php echo htmlentities($result->CityName);?>" placeholder="Create Country" required>
									</div>
								</div>		

															
<div class="form-group">
<label for="focusedinput" class="col-sm-2 control-label">City Image</label>
<div class="col-sm-8">
<img src="countryimages/cityimages/<?php echo htmlentities($result->CityImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-city-image.php?imgid=<?php echo htmlentities($result->CityId);?>">Change Image</a>
</div>
</div>
