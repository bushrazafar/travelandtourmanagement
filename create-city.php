...
move_uploaded_file($_FILES["cimage"]["tmp_name"],"countryimages/cityimages/".$_FILES["cimage"]["name"]);
$sql="INSERT INTO tblcities(CityName,CityImage,countryid) VALUES(:cname,:cimage,:dcountry)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Create City </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="cname" id="cname" placeholder="Create Country" required>
									</div>
								</div>		
