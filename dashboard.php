...
<html>
<head>
<title>E-Travels & Tours | Admin Dashboard</title>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php $sql = "SELECT userid from tblusers";
		...
		<div class="four-grids">
		            <div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Registered Booking</h3>
									<?php $sql3 = "SELECT BookingId from tbl_flight_hotel_booking";
										$query3= $dbh -> prepare($sql3);
										$query3->execute();
										$results3=$query3->fetchAll(PDO::FETCH_OBJ);
										$cnt3=$query3->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Guest Users Bookings</h3>
									<?php $sql1 = "SELECT BookingId from tblguestbooking";
										$query1 = $dbh -> prepare($sql1);
										$query1->execute();
										$results1=$query1->fetchAll(PDO::FETCH_OBJ);
										$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								<h3>Flight Enquiry</h3>

								<?php $sql = "SELECT BookingId from tblflightbooking";
										$query = $dbh -> prepare($sql);
										$query->execute();
										$results=$query->fetchAll(PDO::FETCH_OBJ);
										$cnt=$query->rowCount();
