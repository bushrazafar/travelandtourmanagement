				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Packages</h2>
						...
						<tbody>
<?php $sql = "SELECT * from tblcountries";
...
{				?>		
						  <tr>
							...
							<td><a href="update-country.php?pid=<?php echo htmlentities($result->countryid);?>"><button type="button" class="btn btn-primary btn-block">View Details</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
