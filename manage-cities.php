...
{				?>		
						  <tr>
                            ...
                            <?php
                                $cityid = $result->countryid;
                                $citysql = "SELECT CountryName FROM tblcountries WHERE countryid=".$cityid;
                            ...
                            ?>
                            <td><?php echo htmlentities($CountryName);?></td>
							<td><?php echo htmlentities($result->CreationDate);?></td>
							<td><a href="update-cities.php?pid=<?php echo htmlentities($result->CityId);?>"><button type="button" class="btn btn-primary btn-block">View Details</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
