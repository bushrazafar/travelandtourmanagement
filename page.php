...
?>
		...
		<h3 class="wow fadeInDown animated animated" data-wow-delay="35s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInDown;"><?php 	echo $_GET['type'] ?></h3>
